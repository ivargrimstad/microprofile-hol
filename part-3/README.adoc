...
Copy link:https://github.com/ivargrimstad/microprofile-hol/raw/master/solution/greeting/src/main/liberty/config/resources/security/public.jks[public.jks] to the `src/main/liberty/config/resources/serurity` folder
